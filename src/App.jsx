...
function App() {
  ...
  return (
                ...
                <div className="content-container">
                  ...
                  <div className="recent-bills">
                    <div className="bill-item">
                      ...
                      <p>Aims to improve public school funding and introduce new cirriculm standards to enchance student learning.</p>
                    ...
                    <div className="bill-item">
                      ...
                      <p>Enhances national security through improved cyber defenses, partnership with tech companies, and public awareness compaigns...</p>
                  ...
                  <div className="model-section">
                    ...
                    <a onClick={() => openTextPopup("Our model is specifically designed to summarize federal legislation. This includes, but is not limited to bills, acts, and amendments.  Submitting other types of documents, including unsupported formats, may lead to unexpected or inaccurate results. ")} className="text-link">
                      LEARN MORE
                    </a>
                  </div>
    ...
    <div className="instruction-item-one">
        <p>1. Visit <a href="https://www.congress.gov/" target="_blank" className="website-link">Congress.gov</a></p>
    </div>
    
    <div className="instruction-item-two-to-four">
        <div className="instruction-item">
            <p>2. If you already know the name of your desired legislature, enter it into the search bar, e.g., <span className="highlight-quote">“H.R.1234”</span> or <span className="highlight-quote">“S.5678”</span>. If you would instead like to browse, click the <span className="highlight-quote">“Legislation”</span> navigation button in the top right corner of the site.</p>
            <a onClick={() => openImagePopup("./bill-summary-deploy/images/Legislation.png")} className="image-link">View Legislation Instruction</a>
        </div>

        <div className="instruction-item">
            <p>3. Once you have selected your desired legislation, click the <span className="highlight-quote">“Text”</span> tab</p>
            <a onClick={() => openImagePopup("./bill-summary-deploy/images/text instruction.png")} className="image-link">View Text Instruction</a>
        </div>

        <div className="instruction-item">
            <p>4. If not already selected, click on the XML option, right-click on the document, and select <span className="highlight-quote">“Save As”</span></p>
            <a onClick={() => openImagePopup("./bill-summary-deploy/images/Xml instruction.png")} className="image-link">View XML Instruction</a>
            <a onClick={() => openImagePopup("./bill-summary-deploy/images/Save as instruction.png")} className="image-link">View Save as Instruction</a>
        </div>
    </div>
    ...
    <div className="instruction-item-five">
        <p>5. Once the document has been saved, upload your document by clicking the <span className="highlight-quote">“Try it Yourself”</span> button below and following the instructions.</p>
        <button className="try-it-btn" onClick={toggleUploadPopup}>Try It Yourself!</button>
    </div>
</div>

      </div>

                {isImagePopupOpen && <ImagePopup isOpen={isImagePopupOpen} imageSrc={popupImage} onClose={closeImagePopup} />}
                {isTextPopupOpen && <TextPopup isOpen={isTextPopupOpen} textContent={popupText} onClose={closeTextPopup} />}
                {isUploadPopupOpen && (
                  <>
